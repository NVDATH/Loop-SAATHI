...
* ผู้พัฒนา: NVDA in Thai <nvdainth@gmail.com>
* ดาวน์โหลด [beta version][()
...
และข้อสำคัญคือรองรับภาษาไทยได้ค่อนข้างดีกว่าใช้ service ตัวอื่นๆ

แนะนำให้เข้าไปดูคลิปแนะนำตัวโปรแกรมจากทาง [สำนักหอสมุดเบญญาลัย แหล่งเรียนรู้สำหรับคนตาบอด](https://www.youtube.com/watch?v=Jv6T4W-a_cQ) กันก่อน
...
และตัวส่วนเสริม Loop-SAATHI ที่ผู้เขียนเขียนขึ้นมานี้ จริงๆ ก็ตั้งใจจะเขียนเพื่อใช้งานเอง แต่ก็มองว่าไหนๆ ก็เขียนแล้ว ปรับปรุงให้ผู้ใช้ทั่วไปสามารถใช้งานไดด้วย และนำมาแจกเป็นสาธารณะ ก็น่าจะมีประโยชน์กับคนอื่นได้บ้าง ไม่มากก็น้อย
...
* edit box สำหรับใส่จำนวนหน้าที่ต้องการให้ส่วนเสริมประมวลผล โดยส่วนเสริมจะดึงค่าจำนวนหน้า "ทั้งหมด" ของไฟล์ที่ผู้ใช้เลือกขึ้นมาไว้ให้เป็นค่าปริยาย ซึ่งผู้ใช้สามารถแก้ไขเองได้ หรือหากไม่ต้องการแก้ไขก็เลื่อนผ่านไป
...
โดยหากใครไม่แน่ใจ สามารถเข้าไปดูโค้ด AutoHotkey script ทที่เป็นต้นทางได้จาก [loop-saathi.ahk](https://github.com/NVDATH/Loop-SAATHI/blob/main/loop-Saathi.ahk) และจะนำไป complie ใช้งานเองก็ได้ไม่ว่ากัน...
